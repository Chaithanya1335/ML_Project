...
class DataIngestion:
    ...
    def intiate_ingestion(self):
        logging.info("Entered DataIngestion method or Component")
        try:
...
if __name__ == '__main__':
    ingestobj = DataIngestion()
    train_data,test_data = ingestobj.intiate_ingestion()
